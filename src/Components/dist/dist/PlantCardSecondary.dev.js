...
function PlantCardSecondary(_a) {
  var data = _a.data,
      ...
      rest = __rest(_a, ["data", "handleRemove"]);

  return react_1["default"].createElement(Swipeable_1["default"], {
    overshootRight: false,
    renderRightActions: function renderRightActions() {
      return react_1["default"].createElement(react_native_1.Animated.View, null, react_1["default"].createElement(react_native_1.View, null, react_1["default"].createElement(react_native_gesture_handler_1.RectButton, {
        style: styles.buttonRemove,
        onPress: handleRemove
      }, react_1["default"].createElement(vector_icons_1.Feather, {
        name: "trash",
        size: 32,
        color: colors_1["default"].white
      }))));
    }
  }, react_1["default"].createElement(react_native_gesture_handler_1.RectButton, __assign({
    ...
    style: styles.title
  }, data.name), react_1["default"].createElement(react_native_1.View, {
    style: styles.details
  }, react_1["default"].createElement(react_native_1.Text, {
    style: styles.timeLabel
  }, "Regar \xE0s"), react_1["default"].createElement(react_native_1.Text, {
    style: styles.time
  }, data.hour)))));
}
