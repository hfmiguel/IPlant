...
function EnvironmentButton(_a) {
    var title = _a.title, _b = _a.active, active = _b === void 0 ? false : _b, rest = __rest(_a, ["title", "active"]);
    return (react_1["default"].createElement(react_native_gesture_handler_1.RectButton, __assign({ style: [
            styles.container,
